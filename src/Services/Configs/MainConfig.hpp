...
struct MainConfig
{
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE_WITH_DEFAULT(MainConfig, LOG_FILE, MINECRAFT_LOG_FILE, LAST_POS_FILE, SERVER_URL, SERVER_PORT, MONTHS_PATH, MINECRAFT_SERVER_IP, MINECRAFT_SERVER_PORT, MINECRAFT_SERVER_PASSWORD)
};
